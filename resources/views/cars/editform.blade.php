    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ url('admin/cars/edit') }}" method="post">
                ...
                <input type="text" class="form-control" name="mat" id="mat" value="{{  $car->mat }}" required><br><br>
                ...
                <input type="date" class="form-control" name="date_cir" id="date_cir" value="{{  $car->date_cir }}" required><br><br>

                <label for="km">Kilometrage</label><br>
                <input type="number" class="form-control" name="km" id="km" value="{{  $car->km }}" required><br><br>
